...
> 🧩 The backend service for **Lumora** — a modern, full-featured blog platform
> built with performance and clean architecture in mind.

## 🛠️ Stack

- **[NestJS](https://nestjs.com/)** – progressive Node.js framework
- **[GraphQL](https://graphql.org/)** – flexible and efficient API layer (Apollo
  Server)
- **[Prisma](https://www.prisma.io/)** – modern ORM for PostgreSQL
- **[PostgreSQL](https://www.postgresql.org/)** – relational database
- **[Docker](https://www.docker.com/)** – containerized dev and prod
  environments
